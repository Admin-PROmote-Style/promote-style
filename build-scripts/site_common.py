...
.cta-band{background:linear-gradient(160deg,var(--primary-bright) 0%,var(--primary-deep) 100%);text-align:center;padding:64px 32px;border-radius:0;border-top:1px solid rgba(255,255,255,.08);border-bottom:1px solid rgba(255,255,255,.08)}
