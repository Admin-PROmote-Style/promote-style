...
.process-step{background:var(--panel);border:1px solid rgba(255,255,255,.07);border-radius:14px;padding:26px 22px;position:relative}
...
.card{background:var(--panel);border:1px solid rgba(255,255,255,.07);border-radius:14px;padding:28px;box-shadow:0 12px 28px rgba(0,0,0,.35)}
...
/* footer */
.logo-divider{background:var(--panel);padding:54px 0 60px;text-align:center;border-top:1px solid rgba(255,255,255,.06)}
