...
.process-step{background:var(--panel);border:1px solid rgba(255,255,255,.07);border-radius:14px;padding:26px 22px;position:relative;box-shadow:0 12px 28px rgba(0,0,0,.35)}
...
#pillars .card{animation:cardGlowPulse 4s ease-in-out infinite}
...
/* addons (pricing) */
.addon-grid{display:grid;grid-template-columns:repeat(2,1fr);gap:16px;max-width:900px;margin:0 auto}
...
.cta-band{background:linear-gradient(135deg,var(--primary),#3a0f08);text-align:center;padding:64px 32px;border-radius:0;border-top:1px solid rgba(255,255,255,.08);border-bottom:1px solid rgba(255,255,255,.08);position:relative;overflow:hidden}
